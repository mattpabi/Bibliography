...
router.get("/book/:id", async (req, res) => {
    ...
    try {
        ...
        const bookData = {
            ...
            bookGenre: row.genre_name.replace(/,\s*/g, ", ") + (row.genre_name.endsWith(",") ? " " : ""),
...
router.put("/api/book/:id", async (req, res) => {
    ...
    try {
        ...
        await psqlOperations.updateBook(req.params.id, book_title, book_cover_url, book_description);
...
router.post("/api/addbook", upload.single("add_cover"), async (req, res) => {
    ...
    try {
        ...
        const data_of_book = await psqlOperations.createBook(add_title, book_cover_url, add_description);
